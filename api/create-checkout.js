...
// Pre-created Stripe Price IDs (add yours here as you create them)
const PRICE_IDS = {
  led: 'price_1TiZtiF96AiVlq46Ip4hqJP4', // £20 one-time — LED theme
  // pro: 'price_xxx',       // add when created
  // max: 'price_xxx',       // add when created
  // ultimate: 'price_xxx',  // add when created
};
