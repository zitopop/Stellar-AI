          ...
          body: JSON.stringify({
            ...
            html: `<div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#050505;color:#fff;">
              ...
              <p style="font-size:12px;color:rgba(255,255,255,0.3);margin-top:20px;">
                ...
                <a href="https://discord.gg/e6uRAV9HGA" style="color:#5865F2;">discord.gg/e6uRAV9HGA</a>
              </p>
              <p style="font-size:11px;color:rgba(255,255,255,0.15);margin-top:8px;">support@trystellarai.com</p>
            </div>`,
          }),
        });
        sent++;
