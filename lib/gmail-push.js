...
async function callOwnerForEmail(message) {
  ...
  const purpose = `A new email arrived from ${sender}. Subject: ${subject}. I am calling because you asked me to call whenever a new inbox email arrives.`.slice(0, 300);
  try {
