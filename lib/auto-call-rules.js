...
const RULES = Object.freeze([
  ...
  { category: 'service', severity: 'critical', reason: 'service outage, CI failure or production failure', terms: ['website down', 'site down', 'production failed', 'deployment failed', 'vercel failed', 'build failed', 'ci failed', 'workflow run failed', 'run failed', 'all jobs have failed', 'github actions failed', 'stellar ai ci', 'outage', 'api down', 'server error'] },
