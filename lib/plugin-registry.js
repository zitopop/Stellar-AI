...
export const PLUGIN_REGISTRY = Object.freeze([
  ...
  Object.freeze({
    id:'gmail',
    name:'Gmail',
    description:'Connect Gmail for owner-critical inbox alerts and approved reply drafts. Sending still requires explicit approval.',
    ...
    verified:true,
    skills:["Watch urgent inbox alerts","Prepare replies","Send only with explicit approval"],
    permissions:[
