...
export const PLUGIN_REGISTRY = Object.freeze([
  ...
  Object.freeze({
    id:'github',
    name:'GitHub',
    description:'Repository files, issues, pull requests, commits and code-review workflows.',
    category:'Developer tools',
    status:'coming_soon',
    audience:'signed_in',
    defaultEnabled:false,
    permissions:[
      {id:'repos.read',label:'Read repositories',risk:'read'},
      {id:'repos.write',label:'Write repository files',risk:'write'},
      {id:'pulls.write',label:'Create and update pull requests',risk:'write'},
    ],
  }),
  Object.freeze({
    id:'vercel',
    name:'Vercel',
    description:'Inspect deployments, build logs and project status, with explicit approval for deployment actions.',
    category:'Developer tools',
    status:'coming_soon',
    audience:'signed_in',
    defaultEnabled:false,
    permissions:[
      {id:'deployments.read',label:'Read deployments and logs',risk:'read'},
      {id:'deployments.write',label:'Trigger approved deployments',risk:'write'},
    ],
  }),
  Object.freeze({
    id:'gmail',
