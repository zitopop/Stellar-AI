...
export const PLUGIN_REGISTRY = Object.freeze([
  Object.freeze({
    id:'pc-agent',
    name:'StellarX PC Agent',
    description:'Pair your own Windows PC like a connected app: inspect files, approve edits, and keep active PC work visible.',
    category:'Coding',
    status:'beta',
    audience:'signed_in',
    defaultEnabled:true,
    route:'/desktop',
    developer:"Stellar AI",
    verified:true,
    skills:["Inspect workspace files","Edit approved files","Run approved terminal commands","Open approved links"],
    permissions:[
  ...
  Object.freeze({
    ...
    developer:"Stellar AI",
    verified:true,
    skills:["Inspect an open Roblox place","Create approved scripts and folders","Apply RemoteEvents and RemoteFunctions"],
    permissions:[
  ...
  Object.freeze({
    ...
    developer:"GitHub + Stellar AI",
    verified:true,
    skills:["Inspect repository metadata","Review recent project activity","Use repository context in Stellar workflows"],
    permissions:[
  ...
  Object.freeze({
    ...
    developer:"Vercel + Stellar AI",
    verified:true,
    skills:["Inspect Vercel projects","Review deployment status","Use deployment context in Stellar workflows"],
    permissions:[
  ...
  Object.freeze({
    id:'gmail',
    name:'Gmail',
    description:'Connect Gmail for personal inbox alerts, approved reply drafts and approval-only email workflows.',
    ...
    setupStatus:'oauth_setup_needed',
    setupEnv:['GMAIL_CLIENT_ID'],
    installLabel:'Install Gmail',
    connectLabel:'Connect Gmail',
    developer:"Google + Stellar AI",
    verified:true,
    skills:["Watch urgent inbox alerts","Prepare replies","Send only with explicit approval","Open Email Agent"],
    permissions:[
      {id:'mail.read',label:'Read inbox metadata and selected email',risk:'read'},
      {id:'mail.draft',label:'Create approved drafts later',risk:'write'},
      {id:'mail.send',label:'Send only with explicit approval later',risk:'high'},
    ],
  }),
  Object.freeze({
    id:'google-drive',
    ...
    oauthProvider:'google',
    setupStatus:'oauth_setup_needed',
    setupEnv:['GOOGLE_OAUTH_CLIENT_ID','GOOGLE_OAUTH_CLIENT_SECRET'],
    installLabel:'Install Google Drive',
    connectLabel:'Connect Google Drive',
    developer:"Google",
    verified:false,
    skills:["Read selected Drive files","Create approved Drive files","Use documents as Stellar context"],
    permissions:[
  ...
  Object.freeze({
    ...
    setupStatus:'oauth_setup_needed',
    setupEnv:['GOOGLE_OAUTH_CLIENT_ID','GOOGLE_OAUTH_CLIENT_SECRET'],
    installLabel:'Install Google Calendar',
    connectLabel:'Connect Google Calendar',
    developer:"Google",
    verified:false,
    skills:["Read calendar events","Check availability","Create or update approved events"],
    permissions:[
  ...
  Object.freeze({
    ...
    setupStatus:'oauth_setup_needed',
    setupEnv:['DISCORD_OAUTH_CLIENT_ID','DISCORD_OAUTH_CLIENT_SECRET'],
    installLabel:'Install Discord',
    connectLabel:'Connect Discord',
    developer:"Discord",
    verified:false,
    skills:["Read approved server content","Work with selected channels","Send or update approved content"],
    permissions:[
  ...
  Object.freeze({
    ...
    setupStatus:'oauth_setup_needed',
    setupEnv:['SHOPIFY_API_KEY','SHOPIFY_API_SECRET'],
    installLabel:'Install Shopify',
    connectLabel:'Connect Shopify',
    developer:"Shopify",
    verified:false,
    skills:["Read store data","Review catalogue content","Apply approved store changes"],
    permissions:[
  ...
  Object.freeze({
    ...
    setupStatus:'oauth_setup_needed',
    setupEnv:['STRIPE_CONNECT_CLIENT_ID'],
    installLabel:'Install Stripe',
    connectLabel:'Connect Stripe',
    developer:"Stripe",
    verified:false,
    skills:["Read business billing data","Review payment context","Create approved billing objects"],
    permissions:[
...
export function publicPluginManifest(plugin,{enabled=false,availableToUser=false,exposeSetup=false}={}){
  return {
    ...
    developer:plugin.developer||'Stellar AI',
    verified:plugin.verified===true,
    skills:Array.isArray(plugin.skills)?plugin.skills.slice(0,8):[],
    status:plugin.status,
    audience:plugin.audience,
    connection:plugin.connection||null,
    oauthProvider:plugin.oauthProvider||null,
    setupStatus:exposeSetup?plugin.setupStatus||null:null,
    setupEnv:exposeSetup&&Array.isArray(plugin.setupEnv)?plugin.setupEnv.slice(0,12):[],
    setupNote:exposeSetup?plugin.setupNote||'':'',
