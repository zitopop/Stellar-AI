...
const ALLOWED=new Set(['read_file','list_directory','search_files','git_status','git_diff','apply_patch','write_file','mkdir','run_command','open_url']);
