(() => {
  ...
  function addRevenueConversionLayer() {
    ...
    moneyRow.className = 'stellar-money-cta-row';
    moneyRow.setAttribute('aria-label', 'Business AI offers');
    moneyRow.innerHTML = `
      <a class="stellar-money-cta primary" href="/ai-receptionist">Sell AI receptionist</a>
      <a class="stellar-money-cta" href="/ai-inbox-closer">Close inbox leads</a>
      <a class="stellar-money-cta" href="/small-business-ai">Small business AI</a>
    `;
    ...
    selector.className = 'stellar-revenue-selector';
    selector.setAttribute('aria-labelledby', 'stellar-revenue-title');
    selector.innerHTML = `
      <div class="stellar-revenue-wrap">
        <div class="stellar-revenue-head">
          <span class="stellar-revenue-kicker">Make Stellar useful first</span>
          <h2 id="stellar-revenue-title">Pick the AI worker that makes money.</h2>
          <p>Visitors should not have to guess what Stellar does. These three offers turn the site into a simple business funnel: answer calls, handle enquiries, and follow up leads.</p>
        </div>
        <div class="stellar-revenue-grid">
          <a class="stellar-revenue-card" href="/ai-receptionist">
            <b>☎</b>
            <h3>AI receptionist</h3>
            <p>For businesses missing calls, messages and bookings. Clear offer, easy to understand, easiest to sell monthly.</p>
            <ul><li>Lead capture</li><li>Customer questions</li><li>Booking-style enquiries</li></ul>
            <span>View receptionist offer</span>
          </a>
          <a class="stellar-revenue-card" href="/ai-inbox-closer">
            <b>@</b>
            <h3>Inbox closer</h3>
            <p>For businesses with replies, quotes and leads that need tidy follow-up instead of forgotten messages.</p>
            <ul><li>Reply drafting</li><li>Lead summaries</li><li>Approval before sending</li></ul>
            <span>View inbox offer</span>
          </a>
          <a class="stellar-revenue-card" href="/small-business-ai">
            <b>✦</b>
            <h3>Small business AI</h3>
            <p>For owners who want one AI workspace for support, websites, content, admin and simple automation.</p>
            <ul><li>Website help</li><li>Support workflows</li><li>Business automation</li></ul>
            <span>View business offer</span>
          </a>
        </div>
        <p class="stellar-revenue-foot">Start with a free test in the app, then upgrade to plans or credits when Stellar saves real time. High-impact actions stay approved and controlled.</p>
      </div>
    `;
