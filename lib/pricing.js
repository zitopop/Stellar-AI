...
// Weekly allowances are configured server-side so commercial limits can change without
// exposing raw request counts in the normal usage UI. A missing/invalid value leaves
// the weekly cap disabled rather than inventing an entitlement.
