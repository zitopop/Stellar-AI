...
test('new-chat home stays focused inside the premium Orbit shell', () => {
  ...
  assert.ok(app.includes('What will you <span class="greet-hi-accent">build next?</span>'));
  assert.ok(app.includes('Turn your next FiveM or Roblox idea into something real — build it, fix it, and keep improving it with Stellar.'));
