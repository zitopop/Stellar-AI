...
test('home copy stays focused without quick-start clutter', () => {
  assert.match(appHtml, /What will you <span class="greet-hi-accent">build next\\?<\\/span>/);
  assert.match(appHtml, /Turn your next FiveM or Roblox idea into something real — build it, fix it, and keep improving it with Stellar\\./);
