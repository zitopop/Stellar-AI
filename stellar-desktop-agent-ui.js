(()=> {
  ...
  function mount(){
    ...
    a.id=BUTTON_ID;
    a.href='/desktop';
    a.title='StellarX PC Agent — Codex-style tasks with your paired Windows workspace';
    a.setAttribute('aria-label','Open StellarX PC Agent');
    a.innerHTML='<span aria-hidden="true" style="font-size:16px">⌘</span><span class="stellar-pc-label">StellarX PC Agent</span>';
